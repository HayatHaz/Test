...
<div class="basket-module" dir="ltr">
        ...
        <button class="promo-code-cta"> تـفـعـيـل</button>
      </div>
...
?>
  ...
  <aside>
    <div class="summary" >
        <div class="summary-total-items" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: 600;">
    ...
    <button class="checkout-cta" onclick="location.href='checkoutAfter.php'">اكـمـال الشراء</button>
